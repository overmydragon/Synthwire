...
import { MOCK_USER_PROFILE, TIER_FEATURES, APPROVAL_MODES } from '@/lib/data/mock';
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-violet-300 mt-1">Manage your account, preferences, and billing</p>
      </div>
      ...
      <Tabs defaultValue={activeTab} onChange={setActiveTab}>
        ...
        {activeTab === 'profile' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-1 space-y-6">
              ...
              <Card variant="elevated" padding="lg">
                ...
                <div className="space-y-3 text-sm">
                  <InfoRow label="Email" value={profile.email} icon={MailIcon} />
            ...
            <div className="lg:col-span-2 space-y-6">
              <Card variant="elevated" padding="lg">
                <h3 className="font-medium text-white mb-6">Profile details</h3>
              ...
              <Card variant="elevated" padding="lg">
                <h3 className="font-medium text-white mb-6">Preferences</h3>
                <div className="space-y-4">
        ...
        {activeTab === 'preferences' && (
          <div className="max-w-3xl space-y-6">
            <Card variant="elevated" padding="lg">
              <h3 className="font-medium text-white mb-6">Appearance</h3>
              <div className="grid grid-cols-3 gap-4">
                {(['light', 'dark', 'system'] as const).map(theme => (
                  ...
                  >
                    {theme === 'light' && <SunIcon className="w-8 h-8 mx-auto mb-2 text-amber-400" />}
                    {theme === 'dark' && <MoonIcon className="w-8 h-8 mx-auto mb-2 text-violet-400" />}
                    {theme === 'system' && <ComputerIcon className="w-8 h-8 mx-auto mb-2 text-violet-300" />}
            ...
            <Card variant="elevated" padding="lg">
              <h3 className="font-medium text-white mb-6">Digest settings</h3>
              <div className="space-y-4">
                <SelectField 
                ...
                <SelectField 
                  ...
                  options={['auto_subscribe', 'approve_first', 'recommend_only']}
                />
                <SelectField 
            ...
            <Card variant="elevated" padding="lg">
              <h3 className="font-medium text-white mb-6">Approval modes explained</h3>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-violet-400 text-sm">{mode.description}</p>
                        </div>
                      </div>
                      <input
                        type="radio"
        ...
        {activeTab === 'notifications' && (
          <div className="max-w-3xl space-y-6">
            <Card variant="elevated" padding="lg">
              <h3 className="font-medium text-white mb-6">Delivery channels</h3>
              <div className="space-y-4">
                {[
                  { key: 'emailDigest', label: 'Email digest', description: 'Receive scheduled digests via email', icon: MailIcon },
                  { key: 'emailAlerts', label: 'Email alerts', description: 'Breaking news and urgent updates via email', icon: MailIcon },
            ...
            <Card variant="elevated" padding="lg">
              <h3 className="font-medium text-white mb-6">Smart notifications</h3>
              <div className="space-y-4">
                {[
        ...
        {activeTab === 'billing' && (
          <div className="max-w-3xl space-y-6">
            <Card variant="elevated" padding="lg">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-violet-400">{TIER_FEATURES[currentTier].tagline}</p>
                </div>
                <Badge variant={currentTier === 'free' ? 'outline' : currentTier === 'lite' ? 'violet' : 'success'} size="lg">
            ...
            {currentTier !== 'free' && (
              <Card variant="elevated" padding="lg">
                <h3 className="font-medium text-white mb-6">Payment method</h3>
        ...
        {activeTab === 'integrations' && (
          <div className="max-w-3xl space-y-6">
            <Card variant="elevated" padding="lg">
              <h3 className="font-medium text-white mb-6">Connected accounts</h3>
              <div className="space-y-4">
                {[
                  { name: 'Email (Relay)', status: 'connected', description: 'synthwire_abc123@relay.synthwire.email', icon: MailIcon },
            ...
            <Card variant="elevated" padding="lg">
              <h3 className="font-medium text-white mb-6">MCP Server</h3>
              <p className="text-violet-400 mb-4">Connect AI assistants and external tools to your Synthwire data via the Model Context Protocol.</p>
              <div className="space-y-3">
                <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/10">
                  <div>
                    <p className="font-medium text-white">MCP Server URL</p>
                    <p className="text-violet-400 text-sm font-mono">https://api.synthwire.email/mcp</p>
                  </div>
        ...
        {activeTab === 'security' && (
          <div className="max-w-3xl space-y-6">
            <Card variant="elevated" padding="lg">
              <h3 className="font-medium text-white mb-6">Password</h3>
              <p className="text-violet-400 mb-4">Last changed: March 2026</p>
            ...
            <Card variant="elevated" padding="lg">
              <h3 className="font-medium text-white mb-6">Two-factor authentication</h3>
              <p className="text-violet-400 mb-4">Add an extra layer of security to your account.</p>
              <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/10">
                <div>
            ...
            <Card variant="elevated" padding="lg">
              <h3 className="font-medium text-white mb-6">Active sessions</h3>
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-3 bg-white/5 rounded-xl border border-white/10">
                    <div className="flex items-center gap-3">
                      <ComputerIcon className="w-6 h-6 text-violet-400" />
                      <div>
                    ...
                    {!session.current && (
                      <Button variant="ghost" size="sm" className="text-red-400 hover:text-red-300">
                        <XIcon className="w-4 h-4" /> Revoke
                      </Button>
                    )}
                  </div>
                ))}
              ...
              <Button variant="ghost" className="mt-4 w-full">
                <XIcon className="w-4 h-4" /> Revoke all other sessions
              </Button>
            </Card>
            ...
            <Card variant="elevated" padding="lg" className="border-red-500/20">
              ...
              <p className="text-violet-400 mb-4">Permanently delete your account and all associated data. This action cannot be undone.</p>
...
function BillingTierCard({ tier, features, isCurrent, onSelect }: { 
  ...
  return (
    <div className={`relative p-6 rounded-xl border transition-all ${
      ...
      <div className="mb-4">
        <p className="text-3xl font-bold text-white">${features.price_monthly}</p>
        <p className="text-violet-400">/month</p>
      ...
      <ul className="space-y-2 mb-6">
        <li className="flex items-center gap-2 text-violet-300 text-sm">
          ...
          {features.sources_limit === 'unlimited' ? 'Unlimited sources' : `${features.sources_limit} sources`}
        </li>
        <li className="flex items-center gap-2 text-violet-300 text-sm">
          <CheckIcon className="w-4 h-4 text-emerald-400" />
          {features.archive_days}-day archive
        </li>
...
function IntegrationRow({ name, status, description, icon: Icon, disabled }: { 
  ...
  return (
    <div className={`flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/10 ${disabled ? 'opacity-50' : ''}`}>
      <div className="flex items-center gap-4">
        <Icon className={`w-6 h-6 ${status === 'connected' ? 'text-emerald-400' : 'text-violet-400'}`} />
        <div>
          <p className="font-medium text-white">{name}</p>
          <p className="text-violet-400 text-sm">{description}</p>
        </div>
      </div>
      <div className="flex items-center gap-3">
...
import { CalendarIcon, TrashIcon, BoltIcon, EyeIcon, CheckIcon, XIcon, MailIcon, PhoneIcon, ChatBubbleLeftRightIcon, TruckIcon, ShieldCheckIcon, MagnifyingGlassIcon, ComputerIcon, SunIcon, MoonIcon, CreditCardIcon, KeyIcon, LockClosedIcon } from '@heroicons/react/24/outline';